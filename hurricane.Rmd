...
## apply geom_hurricane to ggmap for any given lat/lon points on path of hurricane katrina_2005

```{r , warning=FALSE, message=FALSE}
storm_observation <- dat[dat$storm_id == "KATRINA_2005" & 
                                      dat$date == ymd_hms("2005-08-29 12:00:00"),]
...
map_plot %>%
  ...
  scale_fill_manual(name = "Wind speed (kts)", 
                    values = c("red", "orange", "yellow")) + 
  ggtitle("katrina_2005")
ggsave(path = "./plots", filename = "katrina_2005.pdf")

```

## apply geom_hurricane to ggmap for any given lat/lon points on path of hurricane Ike_2008
